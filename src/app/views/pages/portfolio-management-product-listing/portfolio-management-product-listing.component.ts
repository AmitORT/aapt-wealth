...
@Component({
  selector: 'app-portfolio-management-product-listing',
  templateUrl: './portfolio-management-product-listing.component.html',
  styleUrls: ['./portfolio-management-product-listing.component.css']
})
export class PortfolioManagementProductListingComponent implements OnInit {
