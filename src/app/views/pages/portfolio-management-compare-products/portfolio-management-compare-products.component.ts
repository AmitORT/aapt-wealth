...
@Component({
  selector: 'app-portfolio-management-compare-products',
  templateUrl: './portfolio-management-compare-products.component.html',
  styleUrls: ['./portfolio-management-compare-products.component.css']
})
export class PortfolioManagementCompareProductsComponent implements OnInit {
